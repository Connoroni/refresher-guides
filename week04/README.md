...
- Now that we're working with APIs and databases we'll have sensitive information that we want to use without revealing it, so we can use environment variables
